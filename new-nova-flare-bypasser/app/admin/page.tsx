    ...
    <div className="min-h-screen p-4 md:p-8" style={{ background: "var(--dark-bg)", position: "relative" }}>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <CardHeader>
            <div className="flex items-center gap-3">
              <Settings className="w-8 h-8" style={{ color: "var(--ice-400)" }} />
              <CardTitle className="text-2xl text-white">Global Webhook Configuration</CardTitle>
            </div>
            <CardDescription style={{ color: "var(--ice-200)" }}>
          ...
          <CardContent className="space-y-4">
            ...
            <Button
              ...
              style={{ background: "linear-gradient(135deg, var(--ice-600), var(--ice-400))", width: "100%" }}
            >
        ...
        >
          <CardHeader>
            <div className="flex items-center gap-3">
              <Activity className="w-8 h-8" style={{ color: "var(--ice-400)" }} />
              <CardTitle className="text-2xl text-white">System Status</CardTitle>
            </div>
            <CardDescription style={{ color: "var(--ice-200)" }}>
              Control the availability of the bypasser
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex gap-4">
              <Button
                ...
                style={{
                  flex: 1,
                  background: siteStatus === "online" ? "var(--ice-600)" : "rgba(15, 23, 42, 0.6)",
              ...
              <Button
                ...
                style={{
                  flex: 1,
                  background: siteStatus === "offline" ? "var(--destructive)" : "rgba(15, 23, 42, 0.6)",
              ...
              <Button
                onClick={() => handleUpdateStatus("updating")}
                style={{
                  flex: 1,
                  background: siteStatus === "updating" ? "var(--warning)" : "rgba(15, 23, 42, 0.6)",
                  border: "1px solid var(--warning)",
                  color: siteStatus === "updating" ? "black" : "white",
                }}
              >
                Updating
              </Button>
            </div>
            <p className="text-center text-sm" style={{ color: "var(--ice-200)" }}>
              Current Status:{" "}
              <span style={{ fontWeight: "bold", textTransform: "uppercase", color: "var(--ice-400)" }}>
                {siteStatus}
              </span>
            </p>
          </CardContent>
